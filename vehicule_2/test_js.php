...
background-color: #6699CC;
	...
	<h1>Modification de la dernière valeur entrée pour faire des tests de fonctionnement</h1>
		...
		<script>
			...
			var requete = "../vehicule_2/bdd2.php?" + "type=" + radVal + "&indice=" + param_indice + "&valeur=" + param_valeur ;
			var caption_bouton ;
			update_caption() ;
			//paramétrage du graphique
			document.mainForm.onclick = function(){
				radVal = document.mainForm.rads.value;
				requete = "../vehicule_2/bdd2.php?" + "type=" + radVal + "&indice=" + param_indice + "&valeur=" + param_valeur ;
				update_caption() ;
				switch (radVal)
				 {
